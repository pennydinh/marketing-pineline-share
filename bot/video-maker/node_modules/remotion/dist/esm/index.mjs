...
const Freeze = ({ frame: frameToFreeze, children, active = true, }) => {
    ...
    return (jsx(TimelineContext.Provider, { value: timelineValue, children: children }));
};
...
const PremountedSequenceRefForwardingFunction = (props, ref) => {
    ...
    return (jsx(Freeze, { frame: from, active: premountingActive, children: jsx(Sequence, { ref: ref, from: from, style: style, _remotionInternalPremountDisplay: premountFor, _remotionInternalIsPremounting: premountingActive, ...otherProps }) }));
};
...
const SequenceRefForwardingFunction = (props, ref) => {
    if (props.layout !== 'none' &&
        ...
        return jsx(PremountedSequence, { ...props, ref: ref });
    }
    return jsx(RegularSequence, { ...props, ref: ref });
};
/**
...
const DELAY_RENDER_RETRIES_LEFT = 'Retries left: ';
const DELAY_RENDER_RETRY_TOKEN = '- Rendering the frame will be retried.';
