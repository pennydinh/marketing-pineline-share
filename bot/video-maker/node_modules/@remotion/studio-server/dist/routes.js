...
const handleFallback = async ({ remotionRoot, hash, response, getCurrentInputProps, getEnvVariables, publicDir, getRenderQueue, getRenderDefaults, numberOfAudioTags, gitSource, }) => {
...
const handleAddAsset = ({ req, res, search, publicDir, }) => {
    try {
        ...
        const absolutePath = node_path_1.default.join(publicDir, folder, file);
        ...
        req.pipe((0, fs_1.createWriteStream)(absolutePath));
        req.on('end', () => {
